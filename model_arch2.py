...
class BottleneckBlock(nn.Module):
    def __init__(self,input_channels,filters,stride=2):
        ...
        self.proj_conv = Conv2d(input_channels,filters[2],(1,1),stride=stride,bias=False)
        self.proj_bn = nn.BatchNorm2d(filters[2])

        self.conv1 = nn.Conv2d(input_channels,filters[0],(1,1),stride=stride,padding=1,bias=False)
        ...
        self.conv3 = nn.Conv2d(filters[1],filters[2],(1,1),padding=1,bias=False)
...
class ResidualBasicBlock(nn.Module):
    def __init__(self,input_channels,filters,stride=2):
        ...
        self.proj_conv = Conv2d(input_channels,filters[1],(1,1),stride=stride,bias=False)
...
class ResNet18(nn.Module):
    def __init__(self,num_classes=1000):
        ...
        self.conv4x_2 = ResidualBasicBlock(128,[256,256],stride=1)
